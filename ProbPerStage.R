...
#Read in data
#import dataset
test_node_data <-read.csv(file = "C:/Users/spborder/Desktop/BN_Project/Example_imgs/Example_imgs.csv", header = TRUE, sep = ",")

#putting data in dataframe format
test_node_data_df<-data.frame(test_node_data)

#scaling test data
test_node_data_df = data.frame(scale(test_node_data_df))
...
write.csv(fullproblist,"C:/Users/spborder/Desktop/BN_Project/ls_test_norm.csv")
